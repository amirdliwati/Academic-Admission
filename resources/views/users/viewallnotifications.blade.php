...
<head>
  <title>Notifications Agent</title>
</head>
          ...
          <div class="card card-primary">
            ...
            @foreach ($notifications as $mynotifications)
                <tr>
                  ...
                  <td><a href="/home/viewapplicationsfromnotifications1/{{$mynotifications->application_id}}/{{$mynotifications->id}}"><button type="button" class="btn btn-info " id="button1">View</button></a></td>
                </tr>
            @endforeach
