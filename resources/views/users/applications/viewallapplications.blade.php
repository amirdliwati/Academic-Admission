    ...
    <!-- Main content -->
          ...
          <div class="card card-primary">
            ...
            @foreach($allapplication as $myapplication)
                ...
                <td><a href="/uploads/applicationfiles/{{$myapplication->user->name}}/{{$myapplication->code}}/admission/admission.pdf"><button type="button" class="btn btn-success" id="button1">Accepted</button></a></td>
                @elseif($myapplication->status == "Rejected")
                <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-rejectd{{$myapplication->id}}" id="button1">Rejected</button></td>
                ...
                @endif
                <td><a href="/home/editapplication1/{{$myapplication->id}}"><button type="button" class="btn btn-warning " id="button1">Edit</button></a></td>
                </tr>
            @endforeach
          ...
          <div class="modal-content">
           ...
           <h4 class="modal-title"> {{"Application Details:    "}}<b>{{$profile->student->first_name}}  {{" "}} {{$profile->student->last_name}}</b></h4></br>
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="/home/viewdocument1/{{$profile->student->id}}">
