...
<div class="card card-secondary">
                ...
                <div class="card-body">
                        ...
                        <form method="post" action="/home/uploaddocument1/{{$idstudent}}" enctype="multipart/form-data" id="edit">
                        @csrf
                        <div class="form-group row">
                        <div class="col-md-6">
      ...
      <div class="modal fade " id="modal-danger{{$selectitems->id}}">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <a href="/home/deletedocument1/{{$selectitems->id}}"><button type="button" class="btn btn-outline-light">Yes</button></a>
