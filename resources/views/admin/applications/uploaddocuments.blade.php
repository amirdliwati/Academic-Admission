...
<div class="card card-secondary">
                ...
                <div class="card-body">
                        ...
                        <form method="post" action="/home/uploaddocument/{{$idstudent}}" enctype="multipart/form-data" id="form">
                        @csrf
                        <div class="form-group row">
                        <div class="col-md-6">
            ...
            <div class="row">
        <div class="col-md-12">
                <a href="/home/viewallapplications"><button type="button" class=" col-md-3 btn btn-primary"> {{ __('Save') }} </button> </a>
      ...
      <div class="modal fade " id="modal-danger{{$selectitems->id}}">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <a href="/home/deletedocument/{{$selectitems->id}}"><button type="button" class="btn btn-outline-light">Yes</button></a>
