...
@section('content')
        ...
        <div class="container">
            <div class="card card-info">
                ...
                <h3 class="card-title">{{ __('Add New Paid To') }}</h3>
                </div>

                <div class="card-body">
                    <form  id="payment" action="/home/addpaymentout" method="POST" >
                        @csrf
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-body">
              ...
              <h2>Are you Sure To Delete Payment Paid ?</h2>
             <h4>{{$payment->id}}</h4>
            </div>
